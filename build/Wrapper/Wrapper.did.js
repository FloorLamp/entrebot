...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        TEMPusedAddresses: IDL.Func([IDL.Text], [IDL.Vec(IDL.Tuple(AccountIdentifier_3, IDL.Principal, SubAccount))], []),
        acceptCycles: IDL.Func([], [], []),
        allPayments: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(SubAccount)))], ["query"]),
        ...
        lock: IDL.Func([TokenIdentifier, IDL.Nat64, AccountIdentifier_3, SubAccount], [Result_7], []),
        ...
        settlements: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, AccountIdentifier_3, IDL.Nat64))], ["query"]),
