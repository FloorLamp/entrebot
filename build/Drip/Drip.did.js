...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        data_of_many: IDL.Func([DataOfQuery], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Vec(LootData)))], ["query"]),
        get_address_book: IDL.Func([], [AddressBook], ["query"]),
        get_airdrops: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Bool))], ["query"]),
        ...
        get_token_properties_range: IDL.Func([IDL.Nat64, IDL.Nat64], [IDL.Vec(IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text)))], ["query"]),
